...
{
    class UserProfileGridView : GridView
    {
        protected override void PrepareContainerForItemOverride(Windows.UI.Xaml.DependencyObject element, object item)
        {
            try
            {
                ...
                {
                    if (UserProfileViewModel.CurrentScreenMetrics.Name == "768")
                    {
                    ...
                    else if (UserProfileViewModel.CurrentScreenMetrics.Name == "1080")
                    {
                        switch (sampleItem.GroupOrdinal)
                        {
                            case 0:
                    ...
                    else if (UserProfileViewModel.CurrentScreenMetrics.Name == "1440" || UserProfileViewModel.CurrentScreenMetrics.Name == "Portrait1440")
                    {
                        switch (sampleItem.GroupOrdinal)
                        {
                            case 0:
                ...
                else if (sampleItem != null && sampleItem.Group.Layout == DataGroup.LayoutType.DualFeature)
                {
                    ...
                    if (LandingPageViewModel.CurrentScreenMetrics.Name == "1440")
                    {
                        switch (sampleItem.GroupOrdinal)
                        {
                            case 0:
                                element.SetValue(VariableSizedWrapGrid.ColumnSpanProperty, 7);
                                element.SetValue(VariableSizedWrapGrid.RowSpanProperty, 22);
                                break;
                            case 1:
                            case 2:
                            case 3:
                         ...
                         //   case 16:
                           // case 17:
                            ...
                            case 14:
                                element.SetValue(VariableSizedWrapGrid.ColumnSpanProperty, 7);
                                element.SetValue(VariableSizedWrapGrid.RowSpanProperty, 16);
                                break;
                        }
                    }
                ...
                {
                    if (sampleItem.GroupOrdinal == 0 || (UserProfileViewModel.CurrentScreenMetrics.Name == "1440" && sampleItem.GroupOrdinal == 4) || (UserProfileViewModel.CurrentScreenMetrics.Name == "1440" && sampleItem.GroupOrdinal == 6))
                    {
                        element.SetValue(VariableSizedWrapGrid.ColumnSpanProperty, 8);
                        element.SetValue(VariableSizedWrapGrid.RowSpanProperty, 8);
                    }
